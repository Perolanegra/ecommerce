        ...
        <div class="row no-gutters">
          <div class="col-md-8 col-lg-7 col-xl-6 offset-md-2 offset-lg-2 offset-xl-3 space-3 space-lg-0">
            ...
            <form method="POST" action="{{ route('login') }}" class="js-validate mt-5">
              ...
              <!-- Title -->
              <div class="mb-7">
                <h2 class="h3 text-primary font-weight-normal mb-0">Olá <span class="font-weight-semi-bold">Cuscuz Lover!</span></h2>
              ...
              <div class="js-form-message form-group">
                ...
                placeholder="Email"
                data-msg="Por favor informe um email válido."
              ...
              <div class="js-form-message form-group">
                ...
                <label class="form-label">
                  <span class="d-flex justify-content-between align-items-center">
                    Senha
                    <a class="link-muted font-weight-normal" href="{{ route('password.request') }}">Esqueceu a senha?</a>
                  </span>
                </label>
                @endif

                <input id="password" type="password" name="password" class="form-control @error('password') is-invalid @enderror" required 
                autocomplete="current-password" placeholder="********" aria-label="********"
                data-msg="Senha incorreta ou inválida. Por favor tente novamente."
                data-error-class="u-has-error"
                data-success-class="u-has-success">
              ...
              <div class="row align-items-center mb-5">
                <div class="col-6">
                    ...
                    <a class="small" href="{{route('register')}}">Registrar</a>
                  </div>
                <div class="col-6 offset-md-6 text-right">
                  <button type="submit" class="btn btn-primary transition-3d-hover">Entrar</button>
                </div>
              </div>
              <!-- End Button -->
            </form>
