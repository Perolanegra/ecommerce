      ...
      <div id="logoAndNav" class="container-fluid">
        ...
        <a class="d-none d-lg-flex navbar-brand u-header__navbar-brand u-header__navbar-brand-center u-header__navbar-brand-text-white" href="{{url('/')}}" aria-label="Cuscuz">
          ...
          <!-- Button -->
            ...
            <div class="ml-auto">
                <a class="btn btn-sm btn-primary transition-3d-hover" href="{{ route('entrar') }}" > <!--target="_blank"-->
                Entrar
                </a>
            </div>
            @endif --}}
          ...
          <div class="col-md-8 col-lg-7 col-xl-6 offset-md-2 offset-lg-2 offset-xl-3 space-3 space-lg-0">
            ...
            <form class="js-validate mt-5" method="POST" action="{{ route('register') }}">
              ...
              <div class="mb-7">
                ...
                <p>Diga um pouco mais sobre você para começar sua jornada de sabor.</p>
              </div>
              <!-- End Title -->
            ...
            <div class="js-form-message form-group">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" placeholder="Nome" 
                        aria-label="Digite seu nome" required
              ...
              <div class="row align-items-center mb-5">
                ...
                <div class="col-7 col-sm-6 text-right">
                  <button type="submit" class="btn btn-primary transition-3d-hover">Criar Conta</button>
                </div>
              </div>
              <!-- End Button -->
            </form>
